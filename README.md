...
> **Fork di Open Interpreter (AGPL-3.0)** — questo progetto estende Open Interpreter con un'app desktop leggera, attivabile a voce ("hey nova"), in grado di controllare il sistema operativo, aprire app (incluso Steam) e avviare giochi per nome, oltre a eseguire tutte le azioni supportate dall'OS mode e dalla Computer API.

[Documentazione](docs/) | [Licenza](LICENSE) | [Open Interpreter Originale](https://github.com/OpenInterpreter/open-interpreter)

## Novità Nova Prime
- **Hotword "hey nova"** per attivazione vocale (ascolto in background)
- **GUI elegante e leggera** (Qt/QML) con waveform "glass" multicolore animata
- **Icona di tray** + scorciatoia globale personalizzabile
- **Apertura app di sistema** con `computer.os.open_app("Nome App")`
- **Integrazione Steam completa**: `computer.os.open_steam_game("Nome Gioco")` o appid
- **Supporto multilingua** (italiano/inglese) con configurazione utente
- **Selezione modelli** hosted o locali (riuso setup locale di Open Interpreter)
...
Oppure usare gli installer sperimentali esistenti e poi:
```bash
...
## Uso rapido
- **Richiama Nova Prime**: "hey nova" e parla naturalmente
- **Aprire un'app**: "apri Safari", "open Visual Studio Code"
- **Avviare un gioco Steam**: "apri steam Baldur's Gate 3", "open steam Half-Life 2"
- **Azioni complesse**: dettale in linguaggio naturale; Nova Prime usa OS mode per eseguirle

## Nota Legale e Licenza
Questo repository è un **fork di Open Interpreter** e mantiene la licenza **AGPL-3.0**. Il marchio "Open Interpreter" appartiene ai rispettivi titolari. "Nova Prime" è il nome della nostra app desktop basata su questo fork.

---

### Open Interpreter - Funzionalità Base

Tutte le funzionalità originali di Open Interpreter rimangono disponibili:
